          ...
          <div>
            <TextAppearAnimation>
              <h2 className="text-appear text-[46px] font-normal leading-[1.1] md:text-7xl md:tracking-[-2.88px] xl:text-[96px]">
                <span className="font-instrument italic">Gururla</span>
                <br />
                Sunarız
              </h2>
            </TextAppearAnimation>
          ...
          <div className="lg:self-end">
            <TextAppearAnimation>
              <p className="text-appear max-w-[470px]">
                Aşağıdaki projeler, ekibimizin yeteneklerini ve yaratıcılığını sergileyen en iyi örneklerdir. Her biri,
                müşteri ihtiyaçlarını ve hedeflerini karşılamak için titizlikle hazırlanmıştır. Her projede, yenilikçi
              </p>
            </TextAppearAnimation>
          </div>
        </div>
