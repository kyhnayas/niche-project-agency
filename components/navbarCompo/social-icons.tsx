...
export function SocialIcons() {
  return (
    <div className="flex gap-6">
      <span>
        <Link href="https://www.facebook.com/profile.php?id=61574738131981">
          <svg
      ...
      <span>
        <Link href="https://www.youtube.com/@NicheProjectAgency">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-[#565656] duration-200 hover:stroke-white"
            width="23"
      ...
      <span>
        <Link href="https://www.instagram.com/nicheprojectagency">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-[#565656] duration-200 hover:stroke-white"
            width="23"
      ...
      <span>
        <Link href="https://www.linkedin.com/company/niche-project-agency/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-[#565656] duration-200 hover:stroke-white"
            width="23"
