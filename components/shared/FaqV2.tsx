    ...
    <section className="pb-14 pt-14 md:pb-16 md:pt-16 lg:pb-[88px] lg:pt-[88px] xl:pb-[100px] xl:pt-[100px]">
      <div className="container">
        <div className="mb-10 flex flex-col items-start justify-center gap-x-10 gap-y-4 md:mb-20 md:flex-row md:items-end lg:justify-between">
          <SectionHeader
            headingTitle="Bize sordukları"
            titleChange={titleChange}
            italicTitle="İnsanların"
            description="Bize sorabileceğiniz sorulara cevaplar hazırladık. Eğer sorunuzun cevabını bulamazsanız, lütfen bizimle iletişime geçin."
          />
        </div>
