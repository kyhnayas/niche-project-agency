...
// Data-----------------
const topContent = [
  'Marka Stratejisi & Danışmanlık',
  'İnsan Kaynakları & Firma İşleyiş Danışmanlığı',
  'Görsel ve Kreatif Tasarım',
  'Görsel İçerik Üretimi',
  'Video Prodüksiyon & Animasyon',
]
const bottomContent = [
  'Web & Dijital Çözümler',
  'Dijital Pazarlama & Reklam Yönetimi',
  'Halkla İlişkiler & PR Yönetimi',
  'Etkinlik & Organizasyon Yönetimi',
  'Deneyim Tasarımı & Marka Aktivasyonu',
  'Marka & Kişisel İtibar Yönetimi',
]
