        ...
        <div className="mb-10 flex flex-col items-start justify-center gap-x-10 gap-y-6 sm:items-center md:mb-20 md:flex-row lg:justify-start">
          <div className="flex-1">
            <RevealWrapper className="rv-badge mb-3 md:mb-4">
              <span className="rv-badge-text">Hizmetlerimiz</span>
            </RevealWrapper>
            <TextAppearAnimation>
              <h2 className="text-appear">
                Dijital <br />
                <span className="font-instrument italic">Varlığınızı</span> Yükseltin
              </h2>
            </TextAppearAnimation>
          </div>
          <div className="flex-1 max-md:w-full">
            <TextAppearAnimation>
              <p className="text-appear max-w-lg max-md:text-justify md:place-self-end md:text-right">
                Markanızı dijitalde %60 oranında yenilikçi yaklaşımlarla dönüştürürken, %40 oranında güçlü geleneksel
                stratejilerle destekliyoruz.
              </p>
            </TextAppearAnimation>

            <RevealWrapper as="ul" className="mt-5 justify-self-end max-md:w-full md:mt-10">
              <li className="mx-auto block w-full text-center md:inline-block md:w-auto">
                <Link href="/iletisim" className="rv-button rv-button-white block md:inline-block">
