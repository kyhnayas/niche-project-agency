...
const MARQUEE_IMAGES = [
  { id: 1, src: '/images/marquee-img/ege-cunda.png' },
  { id: 2, src: '/images/marquee-img/cadde-barista.png' },
  { id: 3, src: '/images/marquee-img/42ler.png' },
  { id: 4, src: '/images/marquee-img/ege-cunda.png' },
  { id: 5, src: '/images/marquee-img/cadde-barista.png' },
  { id: 6, src: '/images/marquee-img/42ler.png' },
  { id: 7, src: '/images/marquee-img/ege-cunda.png' },
  { id: 8, src: '/images/marquee-img/cadde-barista.png' },
  { id: 9, src: '/images/marquee-img/42ler.png' },
  { id: 10, src: '/images/marquee-img/ege-cunda.png' },
  { id: 11, src: '/images/marquee-img/cadde-barista.png' },
  { id: 12, src: '/images/marquee-img/42ler.png' },
]
