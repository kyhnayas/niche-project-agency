          ...
          <div className="grid grid-cols-1 items-center justify-between gap-[30px] md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <RevealWrapper className="text-center">
              ...
              <p className="text-base leading-[1.4] tracking-[0.32px]">
                İlk adımda, markanızı ve ihtiyaçlarınızı anlamak için bir araya geliyoruz. Sizi, hedeflerinizi ve
                beklentilerinizi dinleyerek, nasıl bir yol haritası çizebileceğimizi belirliyoruz.
              </p>
            </RevealWrapper>
            ...
            <RevealWrapper className="text-center">
              ...
              <p className="text-base leading-[1.4] tracking-[0.32px]">
                Firmanızı, sektörünüzü ve mevcut pazarlama stratejinizi daha iyi anlamak için detaylı bir analiz
                yapıyoruz. Bu aşamada güçlü ve gelişime açık yönlerinizi keşfediyoruz.
              </p>
            </RevealWrapper>
            ...
            <RevealWrapper className="text-center">
              ...
              <p className="text-base leading-[1.4] tracking-[0.32px]">
                Standart çözümler yerine, markanıza özel stratejiler geliştiriyoruz. Hedef kitlenize en uygun pazarlama
                yöntemlerini belirleyerek, etkili bir yol haritası oluşturuyoruz.
              </p>
            </RevealWrapper>
            ...
            <RevealWrapper className="text-center">
              ...
              <p className="text-base leading-[1.4] tracking-[0.32px]">
                Tüm analiz ve strateji çalışmalarının ardından, ihtiyaçlarınıza en uygun çözüm önerileriyle detaylı bir
                teklif sunuyoruz. Sizin için en doğru adımları netleştirerek, iş birliğimizi başlatıyoruz!
              </p>
            </RevealWrapper>
          </div>
        </RevealWrapper>
          ...
          <div className="mx-auto block w-full text-center md:inline-block md:w-auto">
            <Link href="/contact" className="rv-button rv-button-sm rv-button-primary block md:inline-block">
              ...
              <div className="rv-button-bottom">
                <span className="text-nowrap">Hadi Başlayalım</span>
              </div>
            </Link>
          </div>
        </div>
