      ...
      <div className="mb-8 text-center md:mb-16">
        ...
        <TextAppearAnimation02>
          <h2 className="text-appear mb-3">
            Size sunduğumuz
            <br />
            <i className="font-instrument"> başlıca hizmetler</i>
          </h2>
        </TextAppearAnimation02>
        <TextAppearAnimation>
          <p className="text-appear mx-auto lg:max-w-[770px]">
            Pazarlama çözümlerimiz, hedefli kampanyalarla etkileşimi ve yatırım getirisini artırarak SEO ve sosyal medya
            aracılığıyla marka görünürlüğünü iyileştirir.
          </p>
        </TextAppearAnimation>
      </div>
