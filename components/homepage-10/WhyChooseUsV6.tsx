        ...
        <div className="mb-16 flex flex-col items-start justify-center gap-x-10 gap-y-4 md:flex-row lg:mb-24 lg:justify-between">
          <div className="md:w-[60%] md:self-start">
            <RevealWrapper className="rv-badge mb-2">
              <span className="rv-badge-text">Neden Niche Project Agency'yi seçmelisiniz.</span>
            </RevealWrapper>
            <TextAppearAnimation>
              <h2 className="text-appear lg:leading-[1.1]">
                Akıllı, Ölçeklenebilir &amp;
                <i className="font-instrument"> Güvenli </i>
                <i className="font-instrument"> çözümler </i>
              </h2>
            </TextAppearAnimation>
          </div>
          ...
          <div className="w-full md:w-[40%] md:max-w-72 md:self-end lg:max-w-[470px]">
            <TextAppearAnimation>
              <p className="text-appear max-w-lg md:place-self-end md:text-right">
                İşletmenize özel, akıllı ve güvenli çözümler sunarak yükselmenizin sorunsuz bir şekilde gerçekleşmesini
                sağlıyoruz.
              </p>
            </TextAppearAnimation>
              ...
              <li className="mx-auto block w-full text-center md:inline-block md:w-auto">
                <Link href="/contact" className="rv-button rv-button-white block md:inline-block">
                  <div className="rv-button-top">
                    <span>Çalışmaya Başlayalım</span>
                  </div>
        ...
        <article>
          <RevealWrapper className="mb-[30px] flex flex-col gap-[30px] max-lg:flex-wrap md:flex-row">
            <RevealWrapper className="flex-1 border px-[30px] py-20 dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Yapay Zeka Destekli Yenilik</h5>
              <p className="text-base leading-[1.6]">
                Otomasyonu ve kullanıcı katılımını artırmak için son teknoloji yapay zekayı kullanın.
              </p>
            </RevealWrapper>
            <RevealWrapper className="flex-1 border px-[30px] py-20 dark:border-dark">
              <span>
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Uygulama Geliştirme</h5>
              <p className="text-base leading-[1.6]">Girişimciler, KOBİ'ler ve işletmeler için özel çözümler.</p>
            </RevealWrapper>
            <RevealWrapper className="flex-1 border px-[30px] py-20 dark:border-dark">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width={61} height={60} viewBox="0 0 61 60" fill="none">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Ölçeklenebilir &amp; Güvenli</h5>
              <p className="text-base leading-[1.6]">
                Büyüme, yüksek performans &amp; güvenlik için oluşturulmuş uygulamalar.
              </p>
            </RevealWrapper>
          </RevealWrapper>
          <RevealWrapper className="flex flex-col gap-[30px] md:flex-row">
            <RevealWrapper className="min-h-[322px] flex-1 border px-[30px] py-20 dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Kusursuz UI/UX</h5>
              <p className="text-base leading-[1.6]">İlgi çekici, sezgisel ve dönüşüm odaklı görseller.</p>
            </RevealWrapper>
            <RevealWrapper className="min-h-[322px] flex-1 border px-[30px] py-20 dark:border-dark">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width={60} height={60} viewBox="0 0 60 60" fill="none">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">Platformlar Arası Geliştirme</h5>
              <p className="text-base leading-[1.6]">Ekran, basılı, dış mekan ve promosyon uyumluluğu.</p>
            </RevealWrapper>
          </RevealWrapper>
        </article>
      </div>
